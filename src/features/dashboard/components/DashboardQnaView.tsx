...
export function DashboardQnaView({
  ...
  return (
    <div className="min-w-0 flex-1 flex flex-col overflow-y-auto md:flex-row md:overflow-hidden">
      <div className="max-h-72 w-full flex-shrink-0 border-b border-slate-800/50 bg-[#020817] flex flex-col md:max-h-none md:w-80 md:border-b-0 md:border-r">
